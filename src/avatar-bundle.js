...
`)+`
`+p);let T=M+m+a,b=M+p+o,w=bu(i,i.VERTEX_SHADER,T),E=bu(i,i.FRAGMENT_SHADER,b);i.attachShader(v,w),i.attachShader(v,E),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function R(C){if(s.debug.checkShaderErrors){let N=i.getProgramInfoLog(v)||"",F=i.getShaderInfoLog(w)||"",V=i.getShaderInfoLog(E)||"",G=N.trim(),O=F.trim(),z=V.trim(),j=!0,K=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(j=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,v,w,E);else{let ue=Au(i,w,"vertex"),pe=Au(i,E,"fragment");Re("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
