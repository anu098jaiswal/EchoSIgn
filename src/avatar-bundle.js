...
`)+`
`+p);let T=M+m+a,S=M+p+o,w=bu(i,i.VERTEX_SHADER,T),E=bu(i,i.FRAGMENT_SHADER,S);i.attachShader(v,w),i.attachShader(v,E),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function C(R){if(s.debug.checkShaderErrors){let F=i.getProgramInfoLog(v)||"",B=i.getShaderInfoLog(w)||"",O=i.getShaderInfoLog(E)||"",G=F.trim(),z=B.trim(),D=O.trim(),K=!0,$=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(K=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,v,w,E);else{let ae=Au(i,w,"vertex"),de=Au(i,E,"fragment");we("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
...
Program Info Log: `+G+`
`+ae+`
`+de)}else G!==""?Se("WebGLProgram: Program Info Log:",G):(z===""||D==="")&&($=!1);$&&(R.diagnostics={runnable:K,programLog:G,vertexShader:{log:z,prefix:m},fragmentShader:{log:D,prefix:p}})}i.deleteShader(w),i.deleteShader(E),x=new Ss(i,v),b=i0(i,v)}let x;this.getUniforms=function(){return x===void 0&&C(this),x};let b;this.getAttributes=function(){return b===void 0&&C(this),b};let W=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return W===!1&&(W=i.getProgramParameter(v,Yg)),W},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(v),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Zg++,this.cacheKey=e,this.usedTimes=1,this.program=v,this.vertexShader=w,this.fragmentShader=E,this}function y0(s,e,t,n,i,r){let a=new ks,o=new Ql,l=new Set,c=[],h=new Map,d=n.logarithmicDepthBuffer,u=n.precision,f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(x){return l.add(x),x===0?"uv":`uv${x}`}function v(x,b,W,R,F){let B=R.fog,O=F.geometry,G=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?R.environment:null,z=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,D=e.get(x.envMap||G,z),K=D&&D.mapping===dr?D.image.height:null,$=f[x.type];x.precision!==null&&(u=n.getMaxPrecision(x.precision),u!==x.precision&&Se("WebGLProgram.getParameters:",x.precision,"not supported, using",u,"instead."));let ae=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,de=ae!==void 0?ae.length:0,oe=0;O.morphAttributes.position!==void 0&&(oe=1),O.morphAttributes.normal!==void 0&&(oe=2),O.morphAttributes.color!==void 0&&(oe=3);let Fe,ot,at,Z;if($){let Je=In[$];Fe=Je.vertexShader,ot=Je.fragmentShader}else Fe=x.vertexShader,ot=x.fragmentShader,o.update(x),at=o.getVertexShaderID(x),Z=o.getFragmentShaderID(x);let ne=s.getRenderTarget(),re=s.state.buffers.depth.getReversed(),Ne=F.isInstancedMesh===!0,Ee=F.isBatchedMesh===!0,Ie=!!x.map,Tt=!!x.matcap,Xe=!!D,Ke=!!x.aoMap,tt=!!x.lightMap,Be=!!x.bumpMap,ht=!!x.normalMap,I=!!x.displacementMap,xt=!!x.emissiveMap,Ye=!!x.metalnessMap,it=!!x.roughnessMap,ye=x.anisotropy>0,A=x.clearcoat>0,_=x.dispersion>0,L=x.iridescence>0,Y=x.sheen>0,J=x.transmission>0,q=ye&&!!x.anisotropyMap,me=A&&!!x.clearcoatMap,ie=A&&!!x.clearcoatNormalMap,Ae=A&&!!x.clearcoatRoughnessMap,Re=L&&!!x.iridescenceMap,j=L&&!!x.iridescenceThicknessMap,ee=Y&&!!x.sheenColorMap,ge=Y&&!!x.sheenRoughnessMap,xe=!!x.specularMap,ue=!!x.specularColorMap,ze=!!x.specularIntensityMap,P=J&&!!x.transmissionMap,se=J&&!!x.thicknessMap,te=!!x.gradientMap,pe=!!x.alphaMap,Q=x.alphaTest>0,X=!!x.alphaHash,_e=!!x.extensions,Pe=fn;x.toneMapped&&(ne===null||ne.isXRRenderTarget===!0)&&(Pe=s.toneMapping);let st={shaderID:$,shaderType:x.type,shaderName:x.name,vertexShader:Fe,fragmentShader:ot,defines:x.defines,customVertexShaderID:at,customFragmentShaderID:Z,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:u,batching:Ee,batchingColor:Ee&&F._colorsTexture!==null,instancing:Ne,instancingColor:Ne&&F.instanceColor!==null,instancingMorph:Ne&&F.morphTexture!==null,outputColorSpace:ne===null?s.outputColorSpace:ne.isXRRenderTarget===!0?ne.texture.colorSpace:Ct,alphaToCoverage:!!x.alphaToCoverage,map:Ie,matcap:Tt,envMap:Xe,envMapMode:Xe&&D.mapping,envMapCubeUVHeight:K,aoMap:Ke,lightMap:tt,bumpMap:Be,normalMap:ht,displacementMap:I,emissiveMap:xt,normalMapObjectSpace:ht&&x.normalMapType===$h,normalMapTangentSpace:ht&&x.normalMapType===Dl,metalnessMap:Ye,roughnessMap:it,anisotropy:ye,anisotropyMap:q,clearcoat:A,clearcoatMap:me,clearcoatNormalMap:ie,clearcoatRoughnessMap:Ae,dispersion:_,iridescence:L,iridescenceMap:Re,iridescenceThicknessMap:j,sheen:Y,sheenColorMap:ee,sheenRoughnessMap:ge,specularMap:xe,specularColorMap:ue,specularIntensityMap:ze,transmission:J,transmissionMap:P,thicknessMap:se,gradientMap:te,opaque:x.transparent===!1&&x.blending===yi&&x.alphaToCoverage===!1,alphaMap:pe,alphaTest:Q,alphaHash:X,combine:x.combine,mapUv:Ie&&g(x.map.channel),aoMapUv:Ke&&g(x.aoMap.channel),lightMapUv:tt&&g(x.lightMap.channel),bumpMapUv:Be&&g(x.bumpMap.channel),normalMapUv:ht&&g(x.normalMap.channel),displacementMapUv:I&&g(x.displacementMap.channel),emissiveMapUv:xt&&g(x.emissiveMap.channel),metalnessMapUv:Ye&&g(x.metalnessMap.channel),roughnessMapUv:it&&g(x.roughnessMap.channel),anisotropyMapUv:q&&g(x.anisotropyMap.channel),clearcoatMapUv:me&&g(x.clearcoatMap.channel),clearcoatNormalMapUv:ie&&g(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ae&&g(x.clearcoatRoughnessMap.channel),iridescenceMapUv:Re&&g(x.iridescenceMap.channel),iridescenceThicknessMapUv:j&&g(x.iridescenceThicknessMap.channel),sheenColorMapUv:ee&&g(x.sheenColorMap.channel),sheenRoughnessMapUv:ge&&g(x.sheenRoughnessMap.channel),specularMapUv:xe&&g(x.specularMap.channel),specularColorMapUv:ue&&g(x.specularColorMap.channel),specularIntensityMapUv:ze&&g(x.specularIntensityMap.channel),transmissionMapUv:P&&g(x.transmissionMap.channel),thicknessMapUv:se&&g(x.thicknessMap.channel),alphaMapUv:pe&&g(x.alphaMap.channel),vertexTangents:!!O.attributes.tangent&&(ht||ye),vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,pointsUvs:F.isPoints===!0&&!!O.attributes.uv&&(Ie||pe),fog:!!B,useFog:x.fog===!0,fogExp2:!!B&&B.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||O.attributes.normal===void 0&&ht===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:re,skinning:F.isSkinnedMesh===!0,morphTargets:O.morphAttributes.position!==void 0,morphNormals:O.morphAttributes.normal!==void 0,morphColors:O.morphAttributes.color!==void 0,morphTargetsCount:de,morphTextureStride:oe,numDirLights:b.directional.length,numPointLights:b.point.length,numSpotLights:b.spot.length,numSpotLightMaps:b.spotLightMap.length,numRectAreaLights:b.rectArea.length,numHemiLights:b.hemi.length,numDirLightShadows:b.directionalShadowMap.length,numPointLightShadows:b.pointShadowMap.length,numSpotLightShadows:b.spotShadowMap.length,numSpotLightShadowsWithMaps:b.numSpotLightShadowsWithMaps,numLightProbes:b.numLightProbes,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:x.dithering,shadowMapEnabled:s.shadowMap.enabled&&W.length>0,shadowMapType:s.shadowMap.type,toneMapping:Pe,decodeVideoTexture:Ie&&x.map.isVideoTexture===!0&&Ge.getTransfer(x.map.colorSpace)===Ze,decodeVideoTextureEmissive:xt&&x.emissiveMap.isVideoTexture===!0&&Ge.getTransfer(x.emissiveMap.colorSpace)===Ze,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===en,flipSided:x.side===Ot,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:_e&&x.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(_e&&x.extensions.multiDraw===!0||Ee)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return st.vertexUv1s=l.has(1),st.vertexUv2s=l.has(2),st.vertexUv3s=l.has(3),l.clear(),st}function m(x){let b=[];if(x.shaderID?b.push(x.shaderID):(b.push(x.customVertexShaderID),b.push(x.customFragmentShaderID)),x.defines!==void 0)for(let W in x.defines)b.push(W),b.push(x.defines[W]);return x.isRawShaderMaterial===!1&&(p(b,x),M(b,x),b.push(s.outputColorSpace)),b.push(x.customProgramCacheKey),b.join()}function p(x,b){x.push(b.precision),x.push(b.outputColorSpace),x.push(b.envMapMode),x.push(b.envMapCubeUVHeight),x.push(b.mapUv),x.push(b.alphaMapUv),x.push(b.lightMapUv),x.push(b.aoMapUv),x.push(b.bumpMapUv),x.push(b.normalMapUv),x.push(b.displacementMapUv),x.push(b.emissiveMapUv),x.push(b.metalnessMapUv),x.push(b.roughnessMapUv),x.push(b.anisotropyMapUv),x.push(b.clearcoatMapUv),x.push(b.clearcoatNormalMapUv),x.push(b.clearcoatRoughnessMapUv),x.push(b.iridescenceMapUv),x.push(b.iridescenceThicknessMapUv),x.push(b.sheenColorMapUv),x.push(b.sheenRoughnessMapUv),x.push(b.specularMapUv),x.push(b.specularColorMapUv),x.push(b.specularIntensityMapUv),x.push(b.transmissionMapUv),x.push(b.thicknessMapUv),x.push(b.combine),x.push(b.fogExp2),x.push(b.sizeAttenuation),x.push(b.morphTargetsCount),x.push(b.morphAttributeCount),x.push(b.numDirLights),x.push(b.numPointLights),x.push(b.numSpotLights),x.push(b.numSpotLightMaps),x.push(b.numHemiLights),x.push(b.numRectAreaLights),x.push(b.numDirLightShadows),x.push(b.numPointLightShadows),x.push(b.numSpotLightShadows),x.push(b.numSpotLightShadowsWithMaps),x.push(b.numLightProbes),x.push(b.shadowMapType),x.push(b.toneMapping),x.push(b.numClippingPlanes),x.push(b.numClipIntersection),x.push(b.depthPacking)}function M(x,b){a.disableAll(),b.instancing&&a.enable(0),b.instancingColor&&a.enable(1),b.instancingMorph&&a.enable(2),b.matcap&&a.enable(3),b.envMap&&a.enable(4),b.normalMapObjectSpace&&a.enable(5),b.normalMapTangentSpace&&a.enable(6),b.clearcoat&&a.enable(7),b.iridescence&&a.enable(8),b.alphaTest&&a.enable(9),b.vertexColors&&a.enable(10),b.vertexAlphas&&a.enable(11),b.vertexUv1s&&a.enable(12),b.vertexUv2s&&a.enable(13),b.vertexUv3s&&a.enable(14),b.vertexTangents&&a.enable(15),b.anisotropy&&a.enable(16),b.alphaHash&&a.enable(17),b.batching&&a.enable(18),b.dispersion&&a.enable(19),b.batchingColor&&a.enable(20),b.gradientMap&&a.enable(21),x.push(a.mask),a.disableAll(),b.fog&&a.enable(0),b.useFog&&a.enable(1),b.flatShading&&a.enable(2),b.logarithmicDepthBuffer&&a.enable(3),b.reversedDepthBuffer&&a.enable(4),b.skinning&&a.enable(5),b.morphTargets&&a.enable(6),b.morphNormals&&a.enable(7),b.morphColors&&a.enable(8),b.premultipliedAlpha&&a.enable(9),b.shadowMapEnabled&&a.enable(10),b.doubleSided&&a.enable(11),b.flipSided&&a.enable(12),b.useDepthPacking&&a.enable(13),b.dithering&&a.enable(14),b.transmission&&a.enable(15),b.sheen&&a.enable(16),b.opaque&&a.enable(17),b.pointsUvs&&a.enable(18),b.decodeVideoTexture&&a.enable(19),b.decodeVideoTextureEmissive&&a.enable(20),b.alphaToCoverage&&a.enable(21),x.push(a.mask)}function T(x){let b=f[x.type],W;if(b){let R=In[b];W=cu.clone(R.uniforms)}else W=x.uniforms;return W}function S(x,b){let W=h.get(b);return W!==void 0?++W.usedTimes:(W=new x0(s,b,x,i),c.push(W),h.set(b,W)),W}function w(x){if(--x.usedTimes===0){let b=c.indexOf(x);c[b]=c[c.length-1],c.pop(),h.delete(x.cacheKey),x.destroy()}}function E(x){o.remove(x)}function C(){o.dispose()}return{getParameters:v,getProgramCacheKey:m,getUniforms:T,acquireProgram:S,releaseProgram:w,releaseShaderCache:E,programs:c,dispose:C}}function M0(){let s=new WeakMap;function e(a){return s.has(a)}function t(a){let o=s.get(a);return o===void 0&&(o={},s.set(a,o)),o}function n(a){s.delete(a)}function i(a,o,l){s.get(a)[o]=l}function r(){s=new WeakMap}return{has:e,get:t,remove:n,update:i,dispose:r}}function S0(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.material.id!==e.material.id?s.material.id-e.material.id:s.materialVariant!==e.materialVariant?s.materialVariant-e.materialVariant:s.z!==e.z?s.z-e.z:s.id-e.id}function Iu(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.z!==e.z?e.z-s.z:s.id-e.id}function Pu(){let s=[],e=0,t=[],n=[],i=[];function r(){e=0,t.length=0,n.length=0,i.length=0}function a(u){let f=0;return u.isInstancedMesh&&(f+=2),u.isSkinnedMesh&&(f+=1),f}function o(u,f,g,v,m,p){let M=s[e];return M===void 0?(M={id:u.id,object:u,geometry:f,material:g,materialVariant:a(u),groupOrder:v,renderOrder:u.renderOrder,z:m,group:p},s[e]=M):(M.id=u.id,M.object=u,M.geometry=f,M.material=g,M.materialVariant=a(u),M.groupOrder=v,M.renderOrder=u.renderOrder,M.z=m,M.group=p),e++,M}function l(u,f,g,v,m,p){let M=o(u,f,g,v,m,p);g.transmission>0?n.push(M):g.transparent===!0?i.push(M):t.push(M)}function c(u,f,g,v,m,p){let M=o(u,f,g,v,m,p);g.transmission>0?n.unshift(M):g.transparent===!0?i.unshift(M):t.unshift(M)}function h(u,f){t.length>1&&t.sort(u||S0),n.length>1&&n.sort(f||Iu),i.length>1&&i.sort(f||Iu)}function d(){for(let u=e,f=s.length;u<f;u++){let g=s[u];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:t,transmissive:n,transparent:i,init:r,push:l,unshift:c,finish:d,sort:h}}function b0(){let s=new WeakMap;function e(n,i){let r=s.get(n),a;return r===void 0?(a=new Pu,s.set(n,[a])):i>=r.length?(a=new Pu,r.push(a)):a=r[i],a}function t(){s=new WeakMap}return{get:e,dispose:t}}function T0(){let s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new U,color:new Ce};break;case"SpotLight":t={position:new U,direction:new U,color:new Ce,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new U,color:new Ce,distance:0,decay:0};break;case"HemisphereLight":t={direction:new U,skyColor:new Ce,groundColor:new Ce};break;case"RectAreaLight":t={color:new Ce,position:new U,halfWidth:new U,halfHeight:new U};break}return s[e.id]=t,t}}}function A0(){let s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new We};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new We};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new We,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[e.id]=t,t}}}function w0(s,e){return(e.castShadow?2:0)-(s.castShadow?2:0)+(e.map?1:0)-(s.map?1:0)}function R0(s){let e=new T0,t=A0(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new U);let i=new U,r=new Ue,a=new Ue;function o(c){let h=0,d=0,u=0;for(let b=0;b<9;b++)n.probe[b].set(0,0,0);let f=0,g=0,v=0,m=0,p=0,M=0,T=0,S=0,w=0,E=0,C=0;c.sort(w0);for(let b=0,W=c.length;b<W;b++){let R=c[b],F=R.color,B=R.intensity,O=R.distance,G=null;if(R.shadow&&R.shadow.map&&(R.shadow.map.texture.format===Pi?G=R.shadow.map.texture:G=R.shadow.map.depthTexture||R.shadow.map.texture),R.isAmbientLight)h+=F.r*B,d+=F.g*B,u+=F.b*B;else if(R.isLightProbe){for(let z=0;z<9;z++)n.probe[z].addScaledVector(R.sh.coefficients[z],B);C++}else if(R.isDirectionalLight){let z=e.get(R);if(z.color.copy(R.color).multiplyScalar(R.intensity),R.castShadow){let D=R.shadow,K=t.get(R);K.shadowIntensity=D.intensity,K.shadowBias=D.bias,K.shadowNormalBias=D.normalBias,K.shadowRadius=D.radius,K.shadowMapSize=D.mapSize,n.directionalShadow[f]=K,n.directionalShadowMap[f]=G,n.directionalShadowMatrix[f]=R.shadow.matrix,M++}n.directional[f]=z,f++}else if(R.isSpotLight){let z=e.get(R);z.position.setFromMatrixPosition(R.matrixWorld),z.color.copy(F).multiplyScalar(B),z.distance=O,z.coneCos=Math.cos(R.angle),z.penumbraCos=Math.cos(R.angle*(1-R.penumbra)),z.decay=R.decay,n.spot[v]=z;let D=R.shadow;if(R.map&&(n.spotLightMap[w]=R.map,w++,D.updateMatrices(R),R.castShadow&&E++),n.spotLightMatrix[v]=D.matrix,R.castShadow){let K=t.get(R);K.shadowIntensity=D.intensity,K.shadowBias=D.bias,K.shadowNormalBias=D.normalBias,K.shadowRadius=D.radius,K.shadowMapSize=D.mapSize,n.spotShadow[v]=K,n.spotShadowMap[v]=G,S++}v++}else if(R.isRectAreaLight){let z=e.get(R);z.color.copy(F).multiplyScalar(B),z.halfWidth.set(R.width*.5,0,0),z.halfHeight.set(0,R.height*.5,0),n.rectArea[m]=z,m++}else if(R.isPointLight){let z=e.get(R);if(z.color.copy(R.color).multiplyScalar(R.intensity),z.distance=R.distance,z.decay=R.decay,R.castShadow){let D=R.shadow,K=t.get(R);K.shadowIntensity=D.intensity,K.shadowBias=D.bias,K.shadowNormalBias=D.normalBias,K.shadowRadius=D.radius,K.shadowMapSize=D.mapSize,K.shadowCameraNear=D.camera.near,K.shadowCameraFar=D.camera.far,n.pointShadow[g]=K,n.pointShadowMap[g]=G,n.pointShadowMatrix[g]=R.shadow.matrix,T++}n.point[g]=z,g++}else if(R.isHemisphereLight){let z=e.get(R);z.skyColor.copy(R.color).multiplyScalar(B),z.groundColor.copy(R.groundColor).multiplyScalar(B),n.hemi[p]=z,p++}}m>0&&(s.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=le.LTC_FLOAT_1,n.rectAreaLTC2=le.LTC_FLOAT_2):(n.rectAreaLTC1=le.LTC_HALF_1,n.rectAreaLTC2=le.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=d,n.ambient[2]=u;let x=n.hash;(x.directionalLength!==f||x.pointLength!==g||x.spotLength!==v||x.rectAreaLength!==m||x.hemiLength!==p||x.numDirectionalShadows!==M||x.numPointShadows!==T||x.numSpotShadows!==S||x.numSpotMaps!==w||x.numLightProbes!==C)&&(n.directional.length=f,n.spot.length=v,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=M,n.directionalShadowMap.length=M,n.pointShadow.length=T,n.pointShadowMap.length=T,n.spotShadow.length=S,n.spotShadowMap.length=S,n.directionalShadowMatrix.length=M,n.pointShadowMatrix.length=T,n.spotLightMatrix.length=S+w-E,n.spotLightMap.length=w,n.numSpotLightShadowsWithMaps=E,n.numLightProbes=C,x.directionalLength=f,x.pointLength=g,x.spotLength=v,x.rectAreaLength=m,x.hemiLength=p,x.numDirectionalShadows=M,x.numPointShadows=T,x.numSpotShadows=S,x.numSpotMaps=w,x.numLightProbes=C,n.version=E0++)}function l(c,h){let d=0,u=0,f=0,g=0,v=0,m=h.matrixWorldInverse;for(let p=0,M=c.length;p<M;p++){let T=c[p];if(T.isDirectionalLight){let S=n.directional[d];S.direction.setFromMatrixPosition(T.matrixWorld),i.setFromMatrixPosition(T.target.matrixWorld),S.direction.sub(i),S.direction.transformDirection(m),d++}else if(T.isSpotLight){let S=n.spot[f];S.position.setFromMatrixPosition(T.matrixWorld),S.position.applyMatrix4(m),S.direction.setFromMatrixPosition(T.matrixWorld),i.setFromMatrixPosition(T.target.matrixWorld),S.direction.sub(i),S.direction.transformDirection(m),f++}else if(T.isRectAreaLight){let S=n.rectArea[g];S.position.setFromMatrixPosition(T.matrixWorld),S.position.applyMatrix4(m),a.identity(),r.copy(T.matrixWorld),r.premultiply(m),a.extractRotation(r),S.halfWidth.set(T.width*.5,0,0),S.halfHeight.set(0,T.height*.5,0),S.halfWidth.applyMatrix4(a),S.halfHeight.applyMatrix4(a),g++}else if(T.isPointLight){let S=n.point[u];S.position.setFromMatrixPosition(T.matrixWorld),S.position.applyMatrix4(m),u++}else if(T.isHemisphereLight){let S=n.hemi[v];S.direction.setFromMatrixPosition(T.matrixWorld),S.direction.transformDirection(m),v++}}}return{setup:o,setupView:l,state:n}}function Lu(s){let e=new R0(s),t=[],n=[];function i(h){c.camera=h,t.length=0,n.length=0}function r(h){t.push(h)}function a(h){n.push(h)}function o(){e.setup(t)}function l(h){e.setupView(t,h)}let c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:i,state:c,setupLights:o,setupLightsView:l,pushLight:r,pushShadow:a}}function C0(s){let e=new WeakMap;function t(i,r=0){let a=e.get(i),o;return a===void 0?(o=new Lu(s),e.set(i,[o])):r>=a.length?(o=new Lu(s),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}function N0(s,e,t){let n=new hs,i=new We,r=new We,a=new rt,o=new ma,l=new ga,c={},h=t.maxTextureSize,d={[hn]:Ot,[Ot]:hn,[en]:en},u=new Kt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new We},radius:{value:4}},vertexShader:I0,fragmentShader:P0}),f=u.clone();f.defines.HORIZONTAL_PASS=1;let g=new It;g.setAttribute("position",new Mt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let v=new gt(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ur;let p=this.type;this.render=function(E,C,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;this.type===Ah&&(Se("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ur);let b=s.getRenderTarget(),W=s.getActiveCubeFace(),R=s.getActiveMipmapLevel(),F=s.state;F.setBlending(wn),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);let B=p!==this.type;B&&C.traverse(function(O){O.material&&(Array.isArray(O.material)?O.material.forEach(G=>G.needsUpdate=!0):O.material.needsUpdate=!0)});for(let O=0,G=E.length;O<G;O++){let z=E[O],D=z.shadow;if(D===void 0){Se("WebGLShadowMap:",z,"has no shadow.");continue}if(D.autoUpdate===!1&&D.needsUpdate===!1)continue;i.copy(D.mapSize);let K=D.getFrameExtents();i.multiply(K),r.copy(D.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/K.x),i.x=r.x*K.x,D.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/K.y),i.y=r.y*K.y,D.mapSize.y=r.y));let $=s.state.buffers.depth.getReversed();if(D.camera._reversedDepth=$,D.map===null||B===!0){if(D.map!==null&&(D.map.depthTexture!==null&&(D.map.depthTexture.dispose(),D.map.depthTexture=null),D.map.dispose()),this.type===gs){if(z.isPointLight){Se("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}D.map=new Yt(i.x,i.y,{format:Pi,type:Rn,minFilter:mt,magFilter:mt,generateMipmaps:!1}),D.map.texture.name=z.name+".shadowMap",D.map.depthTexture=new si(i.x,i.y,Jt),D.map.depthTexture.name=z.name+".shadowMapDepth",D.map.depthTexture.format=yn,D.map.depthTexture.compareFunction=null,D.map.depthTexture.minFilter=pt,D.map.depthTexture.magFilter=pt}else z.isPointLight?(D.map=new bo(i.x),D.map.depthTexture=new fa(i.x,mn)):(D.map=new Yt(i.x,i.y),D.map.depthTexture=new si(i.x,i.y,mn)),D.map.depthTexture.name=z.name+".shadowMap",D.map.depthTexture.format=yn,this.type===ur?(D.map.depthTexture.compareFunction=$?vo:xo,D.map.depthTexture.minFilter=mt,D.map.depthTexture.magFilter=mt):(D.map.depthTexture.compareFunction=null,D.map.depthTexture.minFilter=pt,D.map.depthTexture.magFilter=pt);D.camera.updateProjectionMatrix()}let ae=D.map.isWebGLCubeRenderTarget?6:1;for(let de=0;de<ae;de++){if(D.map.isWebGLCubeRenderTarget)s.setRenderTarget(D.map,de),s.clear();else{de===0&&(s.setRenderTarget(D.map),s.clear());let oe=D.getViewport(de);a.set(r.x*oe.x,r.y*oe.y,r.x*oe.z,r.y*oe.w),F.viewport(a)}if(z.isPointLight){let oe=D.camera,Fe=D.matrix,ot=z.distance||oe.far;ot!==oe.far&&(oe.far=ot,oe.updateProjectionMatrix()),vr.setFromMatrixPosition(z.matrixWorld),oe.position.copy(vr),Yl.copy(oe.position),Yl.add(L0[de]),oe.up.copy(D0[de]),oe.lookAt(Yl),oe.updateMatrixWorld(),Fe.makeTranslation(-vr.x,-vr.y,-vr.z),Du.multiplyMatrices(oe.projectionMatrix,oe.matrixWorldInverse),D._frustum.setFromProjectionMatrix(Du,oe.coordinateSystem,oe.reversedDepth)}else D.updateMatrices(z);n=D.getFrustum(),S(C,x,D.camera,z,this.type)}D.isPointLightShadow!==!0&&this.type===gs&&M(D,x),D.needsUpdate=!1}p=this.type,m.needsUpdate=!1,s.setRenderTarget(b,W,R)};function M(E,C){let x=e.update(v);u.defines.VSM_SAMPLES!==E.blurSamples&&(u.defines.VSM_SAMPLES=E.blurSamples,f.defines.VSM_SAMPLES=E.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new Yt(i.x,i.y,{format:Pi,type:Rn})),u.uniforms.shadow_pass.value=E.map.depthTexture,u.uniforms.resolution.value=E.mapSize,u.uniforms.radius.value=E.radius,s.setRenderTarget(E.mapPass),s.clear(),s.renderBufferDirect(C,null,x,u,v,null),f.uniforms.shadow_pass.value=E.mapPass.texture,f.uniforms.resolution.value=E.mapSize,f.uniforms.radius.value=E.radius,s.setRenderTarget(E.map),s.clear(),s.renderBufferDirect(C,null,x,f,v,null)}function T(E,C,x,b){let W=null,R=x.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(R!==void 0)W=R;else if(W=x.isPointLight===!0?l:o,s.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let F=W.uuid,B=C.uuid,O=c[F];O===void 0&&(O={},c[F]=O);let G=O[B];G===void 0&&(G=W.clone(),O[B]=G,C.addEventListener("dispose",w)),W=G}if(W.visible=C.visible,W.wireframe=C.wireframe,b===gs?W.side=C.shadowSide!==null?C.shadowSide:C.side:W.side=C.shadowSide!==null?C.shadowSide:d[C.side],W.alphaMap=C.alphaMap,W.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,W.map=C.map,W.clipShadows=C.clipShadows,W.clippingPlanes=C.clippingPlanes,W.clipIntersection=C.clipIntersection,W.displacementMap=C.displacementMap,W.displacementScale=C.displacementScale,W.displacementBias=C.displacementBias,W.wireframeLinewidth=C.wireframeLinewidth,W.linewidth=C.linewidth,x.isPointLight===!0&&W.isMeshDistanceMaterial===!0){let F=s.properties.get(W);F.light=x}return W}function S(E,C,x,b,W){if(E.visible===!1)return;if(E.layers.test(C.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&W===gs)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,E.matrixWorld);let B=e.update(E),O=E.material;if(Array.isArray(O)){let G=B.groups;for(let z=0,D=G.length;z<D;z++){let K=G[z],$=O[K.materialIndex];if($&&$.visible){let ae=T(E,$,b,W);E.onBeforeShadow(s,E,C,x,B,ae,K),s.renderBufferDirect(x,null,B,ae,E,K),E.onAfterShadow(s,E,C,x,B,ae,K)}}}else if(O.visible){let G=T(E,O,b,W);E.onBeforeShadow(s,E,C,x,B,G,null),s.renderBufferDirect(x,null,B,G,E,null),E.onAfterShadow(s,E,C,x,B,G,null)}}let F=E.children;for(let B=0,O=F.length;B<O;B++)S(F[B],C,x,b,W)}function w(E){E.target.removeEventListener("dispose",w);for(let x in c){let b=c[x],W=E.target.uuid;W in b&&(b[W].dispose(),delete b[W])}}}function U0(s,e){function t(){let P=!1,se=new rt,te=null,pe=new rt(0,0,0,0);return{setMask:function(Q){te!==Q&&!P&&(s.colorMask(Q,Q,Q,Q),te=Q)},setLocked:function(Q){P=Q},setClear:function(Q,X,_e,Pe,st){st===!0&&(Q*=Pe,X*=Pe,_e*=Pe),se.set(Q,X,_e,Pe),pe.equals(se)===!1&&(s.clearColor(Q,X,_e,Pe),pe.copy(se))},reset:function(){P=!1,te=null,pe.set(-1,0,0,0)}}}function n(){let P=!1,se=!1,te=null,pe=null,Q=null;return{setReversed:function(X){if(se!==X){let _e=e.get("EXT_clip_control");X?_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.ZERO_TO_ONE_EXT):_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.NEGATIVE_ONE_TO_ONE_EXT),se=X;let Pe=Q;Q=null,this.setClear(Pe)}},getReversed:function(){return se},setTest:function(X){X?ne(s.DEPTH_TEST):re(s.DEPTH_TEST)},setMask:function(X){te!==X&&!P&&(s.depthMask(X),te=X)},setFunc:function(X){if(se&&(X=ou[X]),pe!==X){switch(X){case ea:s.depthFunc(s.NEVER);break;case ta:s.depthFunc(s.ALWAYS);break;case na:s.depthFunc(s.LESS);break;case Mi:s.depthFunc(s.LEQUAL);break;case ia:s.depthFunc(s.EQUAL);break;case sa:s.depthFunc(s.GEQUAL);break;case ra:s.depthFunc(s.GREATER);break;case aa:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}pe=X}},setLocked:function(X){P=X},setClear:function(X){Q!==X&&(Q=X,se&&(X=1-X),s.clearDepth(X))},reset:function(){P=!1,te=null,pe=null,Q=null,se=!1}}}function i(){let P=!1,se=null,te=null,pe=null,Q=null,X=null,_e=null,Pe=null,st=null;return{setTest:function(Je){P||(Je?ne(s.STENCIL_TEST):re(s.STENCIL_TEST))},setMask:function(Je){se!==Je&&!P&&(s.stencilMask(Je),se=Je)},setFunc:function(Je,Ln,Dn){(te!==Je||pe!==Ln||Q!==Dn)&&(s.stencilFunc(Je,Ln,Dn),te=Je,pe=Ln,Q=Dn)},setOp:function(Je,Ln,Dn){(X!==Je||_e!==Ln||Pe!==Dn)&&(s.stencilOp(Je,Ln,Dn),X=Je,_e=Ln,Pe=Dn)},setLocked:function(Je){P=Je},setClear:function(Je){st!==Je&&(s.clearStencil(Je),st=Je)},reset:function(){P=!1,se=null,te=null,pe=null,Q=null,X=null,_e=null,Pe=null,st=null}}}let r=new t,a=new n,o=new i,l=new WeakMap,c=new WeakMap,h={},d={},u=new WeakMap,f=[],g=null,v=!1,m=null,p=null,M=null,T=null,S=null,w=null,E=null,C=new Ce(0,0,0),x=0,b=!1,W=null,R=null,F=null,B=null,O=null,G=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS),z=!1,D=0,K=s.getParameter(s.VERSION);K.indexOf("WebGL")!==-1?(D=parseFloat(/^WebGL (\d)/.exec(K)[1]),z=D>=1):K.indexOf("OpenGL ES")!==-1&&(D=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),z=D>=2);let $=null,ae={},de=s.getParameter(s.SCISSOR_BOX),oe=s.getParameter(s.VIEWPORT),Fe=new rt().fromArray(de),ot=new rt().fromArray(oe);function at(P,se,te,pe){let Q=new Uint8Array(4),X=s.createTexture();s.bindTexture(P,X),s.texParameteri(P,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(P,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let _e=0;_e<te;_e++)P===s.TEXTURE_3D||P===s.TEXTURE_2D_ARRAY?s.texImage3D(se,0,s.RGBA,1,1,pe,0,s.RGBA,s.UNSIGNED_BYTE,Q):s.texImage2D(se+_e,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Q);return X}let Z={};Z[s.TEXTURE_2D]=at(s.TEXTURE_2D,s.TEXTURE_2D,1),Z[s.TEXTURE_CUBE_MAP]=at(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[s.TEXTURE_2D_ARRAY]=at(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Z[s.TEXTURE_3D]=at(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ne(s.DEPTH_TEST),a.setFunc(Mi),Be(!1),ht(fl),ne(s.CULL_FACE),Ke(wn);function ne(P){h[P]!==!0&&(s.enable(P),h[P]=!0)}function re(P){h[P]!==!1&&(s.disable(P),h[P]=!1)}function Ne(P,se){return d[P]!==se?(s.bindFramebuffer(P,se),d[P]=se,P===s.DRAW_FRAMEBUFFER&&(d[s.FRAMEBUFFER]=se),P===s.FRAMEBUFFER&&(d[s.DRAW_FRAMEBUFFER]=se),!0):!1}function Ee(P,se){let te=f,pe=!1;if(P){te=u.get(se),te===void 0&&(te=[],u.set(se,te));let Q=P.textures;if(te.length!==Q.length||te[0]!==s.COLOR_ATTACHMENT0){for(let X=0,_e=Q.length;X<_e;X++)te[X]=s.COLOR_ATTACHMENT0+X;te.length=Q.length,pe=!0}}else te[0]!==s.BACK&&(te[0]=s.BACK,pe=!0);pe&&s.drawBuffers(te)}function Ie(P){return g!==P?(s.useProgram(P),g=P,!0):!1}let Tt={[ti]:s.FUNC_ADD,[wh]:s.FUNC_SUBTRACT,[Rh]:s.FUNC_REVERSE_SUBTRACT};Tt[Ch]=s.MIN,Tt[Ih]=s.MAX;let Xe={[Ph]:s.ZERO,[Lh]:s.ONE,[Dh]:s.SRC_COLOR,[jr]:s.SRC_ALPHA,[zh]:s.SRC_ALPHA_SATURATE,[Oh]:s.DST_COLOR,[Uh]:s.DST_ALPHA,[Nh]:s.ONE_MINUS_SRC_COLOR,[Qr]:s.ONE_MINUS_SRC_ALPHA,[Bh]:s.ONE_MINUS_DST_COLOR,[Fh]:s.ONE_MINUS_DST_ALPHA,[kh]:s.CONSTANT_COLOR,[Vh]:s.ONE_MINUS_CONSTANT_COLOR,[Gh]:s.CONSTANT_ALPHA,[Hh]:s.ONE_MINUS_CONSTANT_ALPHA};function Ke(P,se,te,pe,Q,X,_e,Pe,st,Je){if(P===wn){v===!0&&(re(s.BLEND),v=!1);return}if(v===!1&&(ne(s.BLEND),v=!0),P!==Eh){if(P!==m||Je!==b){if((p!==ti||S!==ti)&&(s.blendEquation(s.FUNC_ADD),p=ti,S=ti),Je)switch(P){case yi:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case pl:s.blendFunc(s.ONE,s.ONE);break;case ml:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case gl:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:we("WebGLState: Invalid blending: ",P);break}else switch(P){case yi:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case pl:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case ml:we("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case gl:we("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:we("WebGLState: Invalid blending: ",P);break}M=null,T=null,w=null,E=null,C.set(0,0,0),x=0,m=P,b=Je}return}Q=Q||se,X=X||te,_e=_e||pe,(se!==p||Q!==S)&&(s.blendEquationSeparate(Tt[se],Tt[Q]),p=se,S=Q),(te!==M||pe!==T||X!==w||_e!==E)&&(s.blendFuncSeparate(Xe[te],Xe[pe],Xe[X],Xe[_e]),M=te,T=pe,w=X,E=_e),(Pe.equals(C)===!1||st!==x)&&(s.blendColor(Pe.r,Pe.g,Pe.b,st),C.copy(Pe),x=st),m=P,b=!1}function tt(P,se){P.side===en?re(s.CULL_FACE):ne(s.CULL_FACE);let te=P.side===Ot;se&&(te=!te),Be(te),P.blending===yi&&P.transparent===!1?Ke(wn):Ke(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),r.setMask(P.colorWrite);let pe=P.stencilWrite;o.setTest(pe),pe&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),xt(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?ne(s.SAMPLE_ALPHA_TO_COVERAGE):re(s.SAMPLE_ALPHA_TO_COVERAGE)}function Be(P){W!==P&&(P?s.frontFace(s.CW):s.frontFace(s.CCW),W=P)}function ht(P){P!==bh?(ne(s.CULL_FACE),P!==R&&(P===fl?s.cullFace(s.BACK):P===Th?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):re(s.CULL_FACE),R=P}function I(P){P!==F&&(z&&s.lineWidth(P),F=P)}function xt(P,se,te){P?(ne(s.POLYGON_OFFSET_FILL),(B!==se||O!==te)&&(B=se,O=te,a.getReversed()&&(se=-se),s.polygonOffset(se,te))):re(s.POLYGON_OFFSET_FILL)}function Ye(P){P?ne(s.SCISSOR_TEST):re(s.SCISSOR_TEST)}function it(P){P===void 0&&(P=s.TEXTURE0+G-1),$!==P&&(s.activeTexture(P),$=P)}function ye(P,se,te){te===void 0&&($===null?te=s.TEXTURE0+G-1:te=$);let pe=ae[te];pe===void 0&&(pe={type:void 0,texture:void 0},ae[te]=pe),(pe.type!==P||pe.texture!==se)&&($!==te&&(s.activeTexture(te),$=te),s.bindTexture(P,se||Z[P]),pe.type=P,pe.texture=se)}function A(){let P=ae[$];P!==void 0&&P.type!==void 0&&(s.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function _(){try{s.compressedTexImage2D(...arguments)}catch(P){we("WebGLState:",P)}}function L(){try{s.compressedTexImage3D(...arguments)}catch(P){we("WebGLState:",P)}}function Y(){try{s.texSubImage2D(...arguments)}catch(P){we("WebGLState:",P)}}function J(){try{s.texSubImage3D(...arguments)}catch(P){we("WebGLState:",P)}}function q(){try{s.compressedTexSubImage2D(...arguments)}catch(P){we("WebGLState:",P)}}function me(){try{s.compressedTexSubImage3D(...arguments)}catch(P){we("WebGLState:",P)}}function ie(){try{s.texStorage2D(...arguments)}catch(P){we("WebGLState:",P)}}function Ae(){try{s.texStorage3D(...arguments)}catch(P){we("WebGLState:",P)}}function Re(){try{s.texImage2D(...arguments)}catch(P){we("WebGLState:",P)}}function j(){try{s.texImage3D(...arguments)}catch(P){we("WebGLState:",P)}}function ee(P){Fe.equals(P)===!1&&(s.scissor(P.x,P.y,P.z,P.w),Fe.copy(P))}function ge(P){ot.equals(P)===!1&&(s.viewport(P.x,P.y,P.z,P.w),ot.copy(P))}function xe(P,se){let te=c.get(se);te===void 0&&(te=new WeakMap,c.set(se,te));let pe=te.get(P);pe===void 0&&(pe=s.getUniformBlockIndex(se,P.name),te.set(P,pe))}function ue(P,se){let pe=c.get(se).get(P);l.get(se)!==pe&&(s.uniformBlockBinding(se,pe,P.__bindingPointIndex),l.set(se,pe))}function ze(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),a.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),h={},$=null,ae={},d={},u=new WeakMap,f=[],g=null,v=!1,m=null,p=null,M=null,T=null,S=null,w=null,E=null,C=new Ce(0,0,0),x=0,b=!1,W=null,R=null,F=null,B=null,O=null,Fe.set(0,0,s.canvas.width,s.canvas.height),ot.set(0,0,s.canvas.width,s.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ne,disable:re,bindFramebuffer:Ne,drawBuffers:Ee,useProgram:Ie,setBlending:Ke,setMaterial:tt,setFlipSided:Be,setCullFace:ht,setLineWidth:I,setPolygonOffset:xt,setScissorTest:Ye,activeTexture:it,bindTexture:ye,unbindTexture:A,compressedTexImage2D:_,compressedTexImage3D:L,texImage2D:Re,texImage3D:j,updateUBOMapping:xe,uniformBlockBinding:ue,texStorage2D:ie,texStorage3D:Ae,texSubImage2D:Y,texSubImage3D:J,compressedTexSubImage2D:q,compressedTexSubImage3D:me,scissor:ee,viewport:ge,reset:ze}}function F0(s,e,t,n,i,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new We,h=new WeakMap,d,u=new WeakMap,f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,_){return f?new OffscreenCanvas(A,_):ns("canvas")}function v(A,_,L){let Y=1,J=ye(A);if((J.width>L||J.height>L)&&(Y=L/Math.max(J.width,J.height)),Y<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){let q=Math.floor(Y*J.width),me=Math.floor(Y*J.height);d===void 0&&(d=g(q,me));let ie=_?g(q,me):d;return ie.width=q,ie.height=me,ie.getContext("2d").drawImage(A,0,0,q,me),Se("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+q+"x"+me+")."),ie}else return"data"in A&&Se("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),A;return A}function m(A){return A.generateMipmaps}function p(A){s.generateMipmap(A)}function M(A){return A.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?s.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function T(A,_,L,Y,J=!1){if(A!==null){if(s[A]!==void 0)return s[A];Se("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let q=_;if(_===s.RED&&(L===s.FLOAT&&(q=s.R32F),L===s.HALF_FLOAT&&(q=s.R16F),L===s.UNSIGNED_BYTE&&(q=s.R8)),_===s.RED_INTEGER&&(L===s.UNSIGNED_BYTE&&(q=s.R8UI),L===s.UNSIGNED_SHORT&&(q=s.R16UI),L===s.UNSIGNED_INT&&(q=s.R32UI),L===s.BYTE&&(q=s.R8I),L===s.SHORT&&(q=s.R16I),L===s.INT&&(q=s.R32I)),_===s.RG&&(L===s.FLOAT&&(q=s.RG32F),L===s.HALF_FLOAT&&(q=s.RG16F),L===s.UNSIGNED_BYTE&&(q=s.RG8)),_===s.RG_INTEGER&&(L===s.UNSIGNED_BYTE&&(q=s.RG8UI),L===s.UNSIGNED_SHORT&&(q=s.RG16UI),L===s.UNSIGNED_INT&&(q=s.RG32UI),L===s.BYTE&&(q=s.RG8I),L===s.SHORT&&(q=s.RG16I),L===s.INT&&(q=s.RG32I)),_===s.RGB_INTEGER&&(L===s.UNSIGNED_BYTE&&(q=s.RGB8UI),L===s.UNSIGNED_SHORT&&(q=s.RGB16UI),L===s.UNSIGNED_INT&&(q=s.RGB32UI),L===s.BYTE&&(q=s.RGB8I),L===s.SHORT&&(q=s.RGB16I),L===s.INT&&(q=s.RGB32I)),_===s.RGBA_INTEGER&&(L===s.UNSIGNED_BYTE&&(q=s.RGBA8UI),L===s.UNSIGNED_SHORT&&(q=s.RGBA16UI),L===s.UNSIGNED_INT&&(q=s.RGBA32UI),L===s.BYTE&&(q=s.RGBA8I),L===s.SHORT&&(q=s.RGBA16I),L===s.INT&&(q=s.RGBA32I)),_===s.RGB&&(L===s.UNSIGNED_INT_5_9_9_9_REV&&(q=s.RGB9_E5),L===s.UNSIGNED_INT_10F_11F_11F_REV&&(q=s.R11F_G11F_B10F)),_===s.RGBA){let me=J?Fs:Ge.getTransfer(Y);L===s.FLOAT&&(q=s.RGBA32F),L===s.HALF_FLOAT&&(q=s.RGBA16F),L===s.UNSIGNED_BYTE&&(q=me===Ze?s.SRGB8_ALPHA8:s.RGBA8),L===s.UNSIGNED_SHORT_4_4_4_4&&(q=s.RGBA4),L===s.UNSIGNED_SHORT_5_5_5_1&&(q=s.RGB5_A1)}return(q===s.R16F||q===s.R32F||q===s.RG16F||q===s.RG32F||q===s.RGBA16F||q===s.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function S(A,_){let L;return A?_===null||_===mn||_===vs?L=s.DEPTH24_STENCIL8:_===Jt?L=s.DEPTH32F_STENCIL8:_===xs&&(L=s.DEPTH24_STENCIL8,Se("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===mn||_===vs?L=s.DEPTH_COMPONENT24:_===Jt?L=s.DEPTH_COMPONENT32F:_===xs&&(L=s.DEPTH_COMPONENT16),L}function w(A,_){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==pt&&A.minFilter!==mt?Math.log2(Math.max(_.width,_.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?_.mipmaps.length:1}function E(A){let _=A.target;_.removeEventListener("dispose",E),x(_),_.isVideoTexture&&h.delete(_)}function C(A){let _=A.target;_.removeEventListener("dispose",C),W(_)}function x(A){let _=n.get(A);if(_.__webglInit===void 0)return;let L=A.source,Y=u.get(L);if(Y){let J=Y[_.__cacheKey];J.usedTimes--,J.usedTimes===0&&b(A),Object.keys(Y).length===0&&u.delete(L)}n.remove(A)}function b(A){let _=n.get(A);s.deleteTexture(_.__webglTexture);let L=A.source,Y=u.get(L);delete Y[_.__cacheKey],a.memory.textures--}function W(A){let _=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(_.__webglFramebuffer[Y]))for(let J=0;J<_.__webglFramebuffer[Y].length;J++)s.deleteFramebuffer(_.__webglFramebuffer[Y][J]);else s.deleteFramebuffer(_.__webglFramebuffer[Y]);_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer[Y])}else{if(Array.isArray(_.__webglFramebuffer))for(let Y=0;Y<_.__webglFramebuffer.length;Y++)s.deleteFramebuffer(_.__webglFramebuffer[Y]);else s.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&s.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let Y=0;Y<_.__webglColorRenderbuffer.length;Y++)_.__webglColorRenderbuffer[Y]&&s.deleteRenderbuffer(_.__webglColorRenderbuffer[Y]);_.__webglDepthRenderbuffer&&s.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let L=A.textures;for(let Y=0,J=L.length;Y<J;Y++){let q=n.get(L[Y]);q.__webglTexture&&(s.deleteTexture(q.__webglTexture),a.memory.textures--),n.remove(L[Y])}n.remove(A)}let R=0;function F(){R=0}function B(){let A=R;return A>=i.maxTextures&&Se("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+i.maxTextures),R+=1,A}function O(A){let _=[];return _.push(A.wrapS),_.push(A.wrapT),_.push(A.wrapR||0),_.push(A.magFilter),_.push(A.minFilter),_.push(A.anisotropy),_.push(A.internalFormat),_.push(A.format),_.push(A.type),_.push(A.generateMipmaps),_.push(A.premultiplyAlpha),_.push(A.flipY),_.push(A.unpackAlignment),_.push(A.colorSpace),_.join()}function G(A,_){let L=n.get(A);if(A.isVideoTexture&&Ye(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&L.__version!==A.version){let Y=A.image;if(Y===null)Se("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Se("WebGLRenderer: Texture marked for update but image is incomplete");else{Z(L,A,_);return}}else A.isExternalTexture&&(L.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(s.TEXTURE_2D,L.__webglTexture,s.TEXTURE0+_)}function z(A,_){let L=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&L.__version!==A.version){Z(L,A,_);return}else A.isExternalTexture&&(L.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(s.TEXTURE_2D_ARRAY,L.__webglTexture,s.TEXTURE0+_)}function D(A,_){let L=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&L.__version!==A.version){Z(L,A,_);return}t.bindTexture(s.TEXTURE_3D,L.__webglTexture,s.TEXTURE0+_)}function K(A,_){let L=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&L.__version!==A.version){ne(L,A,_);return}t.bindTexture(s.TEXTURE_CUBE_MAP,L.__webglTexture,s.TEXTURE0+_)}let $={[ni]:s.REPEAT,[Qt]:s.CLAMP_TO_EDGE,[es]:s.MIRRORED_REPEAT},ae={[pt]:s.NEAREST,[Ca]:s.NEAREST_MIPMAP_NEAREST,[Ii]:s.NEAREST_MIPMAP_LINEAR,[mt]:s.LINEAR,[_s]:s.LINEAR_MIPMAP_NEAREST,[pn]:s.LINEAR_MIPMAP_LINEAR},de={[jh]:s.NEVER,[iu]:s.ALWAYS,[Qh]:s.LESS,[xo]:s.LEQUAL,[eu]:s.EQUAL,[vo]:s.GEQUAL,[tu]:s.GREATER,[nu]:s.NOTEQUAL};function oe(A,_){if(_.type===Jt&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===mt||_.magFilter===_s||_.magFilter===Ii||_.magFilter===pn||_.minFilter===mt||_.minFilter===_s||_.minFilter===Ii||_.minFilter===pn)&&Se("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(A,s.TEXTURE_WRAP_S,$[_.wrapS]),s.texParameteri(A,s.TEXTURE_WRAP_T,$[_.wrapT]),(A===s.TEXTURE_3D||A===s.TEXTURE_2D_ARRAY)&&s.texParameteri(A,s.TEXTURE_WRAP_R,$[_.wrapR]),s.texParameteri(A,s.TEXTURE_MAG_FILTER,ae[_.magFilter]),s.texParameteri(A,s.TEXTURE_MIN_FILTER,ae[_.minFilter]),_.compareFunction&&(s.texParameteri(A,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(A,s.TEXTURE_COMPARE_FUNC,de[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===pt||_.minFilter!==Ii&&_.minFilter!==pn||_.type===Jt&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){let L=e.get("EXT_texture_filter_anisotropic");s.texParameterf(A,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,i.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Fe(A,_){let L=!1;A.__webglInit===void 0&&(A.__webglInit=!0,_.addEventListener("dispose",E));let Y=_.source,J=u.get(Y);J===void 0&&(J={},u.set(Y,J));let q=O(_);if(q!==A.__cacheKey){J[q]===void 0&&(J[q]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,L=!0),J[q].usedTimes++;let me=J[A.__cacheKey];me!==void 0&&(J[A.__cacheKey].usedTimes--,me.usedTimes===0&&b(_)),A.__cacheKey=q,A.__webglTexture=J[q].texture}return L}function ot(A,_,L){return Math.floor(Math.floor(A/L)/_)}function at(A,_,L,Y){let q=A.updateRanges;if(q.length===0)t.texSubImage2D(s.TEXTURE_2D,0,0,0,_.width,_.height,L,Y,_.data);else{q.sort((j,ee)=>j.start-ee.start);let me=0;for(let j=1;j<q.length;j++){let ee=q[me],ge=q[j],xe=ee.start+ee.count,ue=ot(ge.start,_.width,4),ze=ot(ee.start,_.width,4);ge.start<=xe+1&&ue===ze&&ot(ge.start+ge.count-1,_.width,4)===ue?ee.count=Math.max(ee.count,ge.start+ge.count-ee.start):(++me,q[me]=ge)}q.length=me+1;let ie=s.getParameter(s.UNPACK_ROW_LENGTH),Ae=s.getParameter(s.UNPACK_SKIP_PIXELS),Re=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,_.width);for(let j=0,ee=q.length;j<ee;j++){let ge=q[j],xe=Math.floor(ge.start/4),ue=Math.ceil(ge.count/4),ze=xe%_.width,P=Math.floor(xe/_.width),se=ue,te=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,ze),s.pixelStorei(s.UNPACK_SKIP_ROWS,P),t.texSubImage2D(s.TEXTURE_2D,0,ze,P,se,te,L,Y,_.data)}A.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,ie),s.pixelStorei(s.UNPACK_SKIP_PIXELS,Ae),s.pixelStorei(s.UNPACK_SKIP_ROWS,Re)}}function Z(A,_,L){let Y=s.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(Y=s.TEXTURE_2D_ARRAY),_.isData3DTexture&&(Y=s.TEXTURE_3D);let J=Fe(A,_),q=_.source;t.bindTexture(Y,A.__webglTexture,s.TEXTURE0+L);let me=n.get(q);if(q.version!==me.__version||J===!0){t.activeTexture(s.TEXTURE0+L);let ie=Ge.getPrimaries(Ge.workingColorSpace),Ae=_.colorSpace===Xn?null:Ge.getPrimaries(_.colorSpace),Re=_.colorSpace===Xn||ie===Ae?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Re);let j=v(_.image,!1,i.maxTextureSize);j=it(_,j);let ee=r.convert(_.format,_.colorSpace),ge=r.convert(_.type),xe=T(_.internalFormat,ee,ge,_.colorSpace,_.isVideoTexture);oe(Y,_);let ue,ze=_.mipmaps,P=_.isVideoTexture!==!0,se=me.__version===void 0||J===!0,te=q.dataReady,pe=w(_,j);if(_.isDepthTexture)xe=S(_.format===li,_.type),se&&(P?t.texStorage2D(s.TEXTURE_2D,1,xe,j.width,j.height):t.texImage2D(s.TEXTURE_2D,0,xe,j.width,j.height,0,ee,ge,null));else if(_.isDataTexture)if(ze.length>0){P&&se&&t.texStorage2D(s.TEXTURE_2D,pe,xe,ze[0].width,ze[0].height);for(let Q=0,X=ze.length;Q<X;Q++)ue=ze[Q],P?te&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,ue.width,ue.height,ee,ge,ue.data):t.texImage2D(s.TEXTURE_2D,Q,xe,ue.width,ue.height,0,ee,ge,ue.data);_.generateMipmaps=!1}else P?(se&&t.texStorage2D(s.TEXTURE_2D,pe,xe,j.width,j.height),te&&at(_,j,ee,ge)):t.texImage2D(s.TEXTURE_2D,0,xe,j.width,j.height,0,ee,ge,j.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){P&&se&&t.texStorage3D(s.TEXTURE_2D_ARRAY,pe,xe,ze[0].width,ze[0].height,j.depth);for(let Q=0,X=ze.length;Q<X;Q++)if(ue=ze[Q],_.format!==$t)if(ee!==null)if(P){if(te)if(_.layerUpdates.size>0){let _e=kl(ue.width,ue.height,_.format,_.type);for(let Pe of _.layerUpdates){let st=ue.data.subarray(Pe*_e/ue.data.BYTES_PER_ELEMENT,(Pe+1)*_e/ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,Pe,ue.width,ue.height,1,ee,st)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,0,ue.width,ue.height,j.depth,ee,ue.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,Q,xe,ue.width,ue.height,j.depth,0,ue.data,0,0);else Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else P?te&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,0,ue.width,ue.height,j.depth,ee,ge,ue.data):t.texImage3D(s.TEXTURE_2D_ARRAY,Q,xe,ue.width,ue.height,j.depth,0,ee,ge,ue.data)}else{P&&se&&t.texStorage2D(s.TEXTURE_2D,pe,xe,ze[0].width,ze[0].height);for(let Q=0,X=ze.length;Q<X;Q++)ue=ze[Q],_.format!==$t?ee!==null?P?te&&t.compressedTexSubImage2D(s.TEXTURE_2D,Q,0,0,ue.width,ue.height,ee,ue.data):t.compressedTexImage2D(s.TEXTURE_2D,Q,xe,ue.width,ue.height,0,ue.data):Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?te&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,ue.width,ue.height,ee,ge,ue.data):t.texImage2D(s.TEXTURE_2D,Q,xe,ue.width,ue.height,0,ee,ge,ue.data)}else if(_.isDataArrayTexture)if(P){if(se&&t.texStorage3D(s.TEXTURE_2D_ARRAY,pe,xe,j.width,j.height,j.depth),te)if(_.layerUpdates.size>0){let Q=kl(j.width,j.height,_.format,_.type);for(let X of _.layerUpdates){let _e=j.data.subarray(X*Q/j.data.BYTES_PER_ELEMENT,(X+1)*Q/j.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,X,j.width,j.height,1,ee,ge,_e)}_.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,j.width,j.height,j.depth,ee,ge,j.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,xe,j.width,j.height,j.depth,0,ee,ge,j.data);else if(_.isData3DTexture)P?(se&&t.texStorage3D(s.TEXTURE_3D,pe,xe,j.width,j.height,j.depth),te&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,j.width,j.height,j.depth,ee,ge,j.data)):t.texImage3D(s.TEXTURE_3D,0,xe,j.width,j.height,j.depth,0,ee,ge,j.data);else if(_.isFramebufferTexture){if(se)if(P)t.texStorage2D(s.TEXTURE_2D,pe,xe,j.width,j.height);else{let Q=j.width,X=j.height;for(let _e=0;_e<pe;_e++)t.texImage2D(s.TEXTURE_2D,_e,xe,Q,X,0,ee,ge,null),Q>>=1,X>>=1}}else if(ze.length>0){if(P&&se){let Q=ye(ze[0]);t.texStorage2D(s.TEXTURE_2D,pe,xe,Q.width,Q.height)}for(let Q=0,X=ze.length;Q<X;Q++)ue=ze[Q],P?te&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,ee,ge,ue):t.texImage2D(s.TEXTURE_2D,Q,xe,ee,ge,ue);_.generateMipmaps=!1}else if(P){if(se){let Q=ye(j);t.texStorage2D(s.TEXTURE_2D,pe,xe,Q.width,Q.height)}te&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,ee,ge,j)}else t.texImage2D(s.TEXTURE_2D,0,xe,ee,ge,j);m(_)&&p(Y),me.__version=q.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function ne(A,_,L){if(_.image.length!==6)return;let Y=Fe(A,_),J=_.source;t.bindTexture(s.TEXTURE_CUBE_MAP,A.__webglTexture,s.TEXTURE0+L);let q=n.get(J);if(J.version!==q.__version||Y===!0){t.activeTexture(s.TEXTURE0+L);let me=Ge.getPrimaries(Ge.workingColorSpace),ie=_.colorSpace===Xn?null:Ge.getPrimaries(_.colorSpace),Ae=_.colorSpace===Xn||me===ie?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);let Re=_.isCompressedTexture||_.image[0].isCompressedTexture,j=_.image[0]&&_.image[0].isDataTexture,ee=[];for(let X=0;X<6;X++)!Re&&!j?ee[X]=v(_.image[X],!0,i.maxCubemapSize):ee[X]=j?_.image[X].image:_.image[X],ee[X]=it(_,ee[X]);let ge=ee[0],xe=r.convert(_.format,_.colorSpace),ue=r.convert(_.type),ze=T(_.internalFormat,xe,ue,_.colorSpace),P=_.isVideoTexture!==!0,se=q.__version===void 0||Y===!0,te=J.dataReady,pe=w(_,ge);oe(s.TEXTURE_CUBE_MAP,_);let Q;if(Re){P&&se&&t.texStorage2D(s.TEXTURE_CUBE_MAP,pe,ze,ge.width,ge.height);for(let X=0;X<6;X++){Q=ee[X].mipmaps;for(let _e=0;_e<Q.length;_e++){let Pe=Q[_e];_.format!==$t?xe!==null?P?te&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e,0,0,Pe.width,Pe.height,xe,Pe.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e,ze,Pe.width,Pe.height,0,Pe.data):Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?te&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e,0,0,Pe.width,Pe.height,xe,ue,Pe.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e,ze,Pe.width,Pe.height,0,xe,ue,Pe.data)}}}else{if(Q=_.mipmaps,P&&se){Q.length>0&&pe++;let X=ye(ee[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,pe,ze,X.width,X.height)}for(let X=0;X<6;X++)if(j){P?te&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,ee[X].width,ee[X].height,xe,ue,ee[X].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,ze,ee[X].width,ee[X].height,0,xe,ue,ee[X].data);for(let _e=0;_e<Q.length;_e++){let st=Q[_e].image[X].image;P?te&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e+1,0,0,st.width,st.height,xe,ue,st.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e+1,ze,st.width,st.height,0,xe,ue,st.data)}}else{P?te&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,xe,ue,ee[X]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,ze,xe,ue,ee[X]);for(let _e=0;_e<Q.length;_e++){let Pe=Q[_e];P?te&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e+1,0,0,xe,ue,Pe.image[X]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e+1,ze,xe,ue,Pe.image[X])}}}m(_)&&p(s.TEXTURE_CUBE_MAP),q.__version=J.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function re(A,_,L,Y,J,q){let me=r.convert(L.format,L.colorSpace),ie=r.convert(L.type),Ae=T(L.internalFormat,me,ie,L.colorSpace),Re=n.get(_),j=n.get(L);if(j.__renderTarget=_,!Re.__hasExternalTextures){let ee=Math.max(1,_.width>>q),ge=Math.max(1,_.height>>q);J===s.TEXTURE_3D||J===s.TEXTURE_2D_ARRAY?t.texImage3D(J,q,Ae,ee,ge,_.depth,0,me,ie,null):t.texImage2D(J,q,Ae,ee,ge,0,me,ie,null)}t.bindFramebuffer(s.FRAMEBUFFER,A),xt(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Y,J,j.__webglTexture,0,I(_)):(J===s.TEXTURE_2D||J>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,Y,J,j.__webglTexture,q),t.bindFramebuffer(s.FRAMEBUFFER,null)}function Ne(A,_,L){if(s.bindRenderbuffer(s.RENDERBUFFER,A),_.depthBuffer){let Y=_.depthTexture,J=Y&&Y.isDepthTexture?Y.type:null,q=S(_.stencilBuffer,J),me=_.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;xt(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,I(_),q,_.width,_.height):L?s.renderbufferStorageMultisample(s.RENDERBUFFER,I(_),q,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,q,_.width,_.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,me,s.RENDERBUFFER,A)}else{let Y=_.textures;for(let J=0;J<Y.length;J++){let q=Y[J],me=r.convert(q.format,q.colorSpace),ie=r.convert(q.type),Ae=T(q.internalFormat,me,ie,q.colorSpace);xt(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,I(_),Ae,_.width,_.height):L?s.renderbufferStorageMultisample(s.RENDERBUFFER,I(_),Ae,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,Ae,_.width,_.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Ee(A,_,L){let Y=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(s.FRAMEBUFFER,A),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let J=n.get(_.depthTexture);if(J.__renderTarget=_,(!J.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),Y){if(J.__webglInit===void 0&&(J.__webglInit=!0,_.depthTexture.addEventListener("dispose",E)),J.__webglTexture===void 0){J.__webglTexture=s.createTexture(),t.bindTexture(s.TEXTURE_CUBE_MAP,J.__webglTexture),oe(s.TEXTURE_CUBE_MAP,_.depthTexture);let Re=r.convert(_.depthTexture.format),j=r.convert(_.depthTexture.type),ee;_.depthTexture.format===yn?ee=s.DEPTH_COMPONENT24:_.depthTexture.format===li&&(ee=s.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)s.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,ee,_.width,_.height,0,Re,j,null)}}else G(_.depthTexture,0);let q=J.__webglTexture,me=I(_),ie=Y?s.TEXTURE_CUBE_MAP_POSITIVE_X+L:s.TEXTURE_2D,Ae=_.depthTexture.format===li?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;if(_.depthTexture.format===yn)xt(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Ae,ie,q,0,me):s.framebufferTexture2D(s.FRAMEBUFFER,Ae,ie,q,0);else if(_.depthTexture.format===li)xt(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Ae,ie,q,0,me):s.framebufferTexture2D(s.FRAMEBUFFER,Ae,ie,q,0);else throw new Error("Unknown depthTexture format")}function Ie(A){let _=n.get(A),L=A.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==A.depthTexture){let Y=A.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),Y){let J=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,Y.removeEventListener("dispose",J)};Y.addEventListener("dispose",J),_.__depthDisposeCallback=J}_.__boundDepthTexture=Y}if(A.depthTexture&&!_.__autoAllocateDepthBuffer)if(L)for(let Y=0;Y<6;Y++)Ee(_.__webglFramebuffer[Y],A,Y);else{let Y=A.texture.mipmaps;Y&&Y.length>0?Ee(_.__webglFramebuffer[0],A,0):Ee(_.__webglFramebuffer,A,0)}else if(L){_.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[Y]),_.__webglDepthbuffer[Y]===void 0)_.__webglDepthbuffer[Y]=s.createRenderbuffer(),Ne(_.__webglDepthbuffer[Y],A,!1);else{let J=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,q=_.__webglDepthbuffer[Y];s.bindRenderbuffer(s.RENDERBUFFER,q),s.framebufferRenderbuffer(s.FRAMEBUFFER,J,s.RENDERBUFFER,q)}}else{let Y=A.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=s.createRenderbuffer(),Ne(_.__webglDepthbuffer,A,!1);else{let J=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,q=_.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,q),s.framebufferRenderbuffer(s.FRAMEBUFFER,J,s.RENDERBUFFER,q)}}t.bindFramebuffer(s.FRAMEBUFFER,null)}function Tt(A,_,L){let Y=n.get(A);_!==void 0&&re(Y.__webglFramebuffer,A,A.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),L!==void 0&&Ie(A)}function Xe(A){let _=A.texture,L=n.get(A),Y=n.get(_);A.addEventListener("dispose",C);let J=A.textures,q=A.isWebGLCubeRenderTarget===!0,me=J.length>1;if(me||(Y.__webglTexture===void 0&&(Y.__webglTexture=s.createTexture()),Y.__version=_.version,a.memory.textures++),q){L.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer[ie]=[];for(let Ae=0;Ae<_.mipmaps.length;Ae++)L.__webglFramebuffer[ie][Ae]=s.createFramebuffer()}else L.__webglFramebuffer[ie]=s.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer=[];for(let ie=0;ie<_.mipmaps.length;ie++)L.__webglFramebuffer[ie]=s.createFramebuffer()}else L.__webglFramebuffer=s.createFramebuffer();if(me)for(let ie=0,Ae=J.length;ie<Ae;ie++){let Re=n.get(J[ie]);Re.__webglTexture===void 0&&(Re.__webglTexture=s.createTexture(),a.memory.textures++)}if(A.samples>0&&xt(A)===!1){L.__webglMultisampledFramebuffer=s.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let ie=0;ie<J.length;ie++){let Ae=J[ie];L.__webglColorRenderbuffer[ie]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,L.__webglColorRenderbuffer[ie]);let Re=r.convert(Ae.format,Ae.colorSpace),j=r.convert(Ae.type),ee=T(Ae.internalFormat,Re,j,Ae.colorSpace,A.isXRRenderTarget===!0),ge=I(A);s.renderbufferStorageMultisample(s.RENDERBUFFER,ge,ee,A.width,A.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ie,s.RENDERBUFFER,L.__webglColorRenderbuffer[ie])}s.bindRenderbuffer(s.RENDERBUFFER,null),A.depthBuffer&&(L.__webglDepthRenderbuffer=s.createRenderbuffer(),Ne(L.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(q){t.bindTexture(s.TEXTURE_CUBE_MAP,Y.__webglTexture),oe(s.TEXTURE_CUBE_MAP,_);for(let ie=0;ie<6;ie++)if(_.mipmaps&&_.mipmaps.length>0)for(let Ae=0;Ae<_.mipmaps.length;Ae++)re(L.__webglFramebuffer[ie][Ae],A,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae);else re(L.__webglFramebuffer[ie],A,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);m(_)&&p(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(me){for(let ie=0,Ae=J.length;ie<Ae;ie++){let Re=J[ie],j=n.get(Re),ee=s.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ee=A.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(ee,j.__webglTexture),oe(ee,Re),re(L.__webglFramebuffer,A,Re,s.COLOR_ATTACHMENT0+ie,ee,0),m(Re)&&p(ee)}t.unbindTexture()}else{let ie=s.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ie=A.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(ie,Y.__webglTexture),oe(ie,_),_.mipmaps&&_.mipmaps.length>0)for(let Ae=0;Ae<_.mipmaps.length;Ae++)re(L.__webglFramebuffer[Ae],A,_,s.COLOR_ATTACHMENT0,ie,Ae);else re(L.__webglFramebuffer,A,_,s.COLOR_ATTACHMENT0,ie,0);m(_)&&p(ie),t.unbindTexture()}A.depthBuffer&&Ie(A)}function Ke(A){let _=A.textures;for(let L=0,Y=_.length;L<Y;L++){let J=_[L];if(m(J)){let q=M(A),me=n.get(J).__webglTexture;t.bindTexture(q,me),p(q),t.unbindTexture()}}}let tt=[],Be=[];function ht(A){if(A.samples>0){if(xt(A)===!1){let _=A.textures,L=A.width,Y=A.height,J=s.COLOR_BUFFER_BIT,q=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,me=n.get(A),ie=_.length>1;if(ie)for(let Re=0;Re<_.length;Re++)t.bindFramebuffer(s.FRAMEBUFFER,me.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Re,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,me.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Re,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,me.__webglMultisampledFramebuffer);let Ae=A.texture.mipmaps;Ae&&Ae.length>0?t.bindFramebuffer(s.DRAW_FRAMEBUFFER,me.__webglFramebuffer[0]):t.bindFramebuffer(s.DRAW_FRAMEBUFFER,me.__webglFramebuffer);for(let Re=0;Re<_.length;Re++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(J|=s.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(J|=s.STENCIL_BUFFER_BIT)),ie){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,me.__webglColorRenderbuffer[Re]);let j=n.get(_[Re]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,j,0)}s.blitFramebuffer(0,0,L,Y,0,0,L,Y,J,s.NEAREST),l===!0&&(tt.length=0,Be.length=0,tt.push(s.COLOR_ATTACHMENT0+Re),A.depthBuffer&&A.resolveDepthBuffer===!1&&(tt.push(q),Be.push(q),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Be)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,tt))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),ie)for(let Re=0;Re<_.length;Re++){t.bindFramebuffer(s.FRAMEBUFFER,me.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Re,s.RENDERBUFFER,me.__webglColorRenderbuffer[Re]);let j=n.get(_[Re]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,me.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Re,s.TEXTURE_2D,j,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,me.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){let _=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[_])}}}function I(A){return Math.min(i.maxSamples,A.samples)}function xt(A){let _=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Ye(A){let _=a.render.frame;h.get(A)!==_&&(h.set(A,_),A.update())}function it(A,_){let L=A.colorSpace,Y=A.format,J=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||L!==Ct&&L!==Xn&&(Ge.getTransfer(L)===Ze?(Y!==$t||J!==Gt)&&Se("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):we("WebGLTextures: Unsupported texture color space:",L)),_}function ye(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=B,this.resetTextureUnits=F,this.setTexture2D=G,this.setTexture2DArray=z,this.setTexture3D=D,this.setTextureCube=K,this.rebindTextures=Tt,this.setupRenderTarget=Xe,this.updateRenderTargetMipmap=Ke,this.updateMultisampleRenderTarget=ht,this.setupDepthRenderbuffer=Ie,this.setupFrameBufferTexture=re,this.useMultisampledRTT=xt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function O0(s,e){function t(n,i=Xn){let r,a=Ge.getTransfer(i);if(n===Gt)return s.UNSIGNED_BYTE;if(n===Pa)return s.UNSIGNED_SHORT_4_4_4_4;if(n===La)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Rl)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Cl)return s.UNSIGNED_INT_10F_11F_11F_REV;if(n===El)return s.BYTE;if(n===wl)return s.SHORT;if(n===xs)return s.UNSIGNED_SHORT;if(n===Ia)return s.INT;if(n===mn)return s.UNSIGNED_INT;if(n===Jt)return s.FLOAT;if(n===Rn)return s.HALF_FLOAT;if(n===Il)return s.ALPHA;if(n===Pl)return s.RGB;if(n===$t)return s.RGBA;if(n===yn)return s.DEPTH_COMPONENT;if(n===li)return s.DEPTH_STENCIL;if(n===Da)return s.RED;if(n===Na)return s.RED_INTEGER;if(n===Pi)return s.RG;if(n===Ua)return s.RG_INTEGER;if(n===Fa)return s.RGBA_INTEGER;if(n===fr||n===pr||n===mr||n===gr)if(a===Ze)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===fr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===pr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===mr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===gr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===fr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===pr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===mr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===gr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Oa||n===Ba||n===za||n===ka)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Oa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ba)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===za)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ka)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Va||n===Ga||n===Ha||n===Wa||n===Xa||n===qa||n===Ya)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Va||n===Ga)return a===Ze?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Ha)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Wa)return r.COMPRESSED_R11_EAC;if(n===Xa)return r.COMPRESSED_SIGNED_R11_EAC;if(n===qa)return r.COMPRESSED_RG11_EAC;if(n===Ya)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Za||n===Ka||n===Ja||n===$a||n===ja||n===Qa||n===eo||n===to||n===no||n===io||n===so||n===ro||n===ao||n===oo)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Za)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ka)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ja)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===$a)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ja)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Qa)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===eo)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===to)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===no)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===io)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===so)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ro)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ao)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===oo)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===lo||n===co||n===ho)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===lo)return a===Ze?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===co)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ho)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===uo||n===fo||n===po||n===mo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===uo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===fo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===po)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===mo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===vs?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}function V0(s,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Ol(s)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function i(m,p,M,T,S){p.isMeshBasicMaterial?r(m,p):p.isMeshLambertMaterial?(r(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(r(m,p),d(m,p)):p.isMeshPhongMaterial?(r(m,p),h(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(r(m,p),u(m,p),p.isMeshPhysicalMaterial&&f(m,p,S)):p.isMeshMatcapMaterial?(r(m,p),g(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),v(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,M,T):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Ot&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Ot&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);let M=e.get(p),T=M.envMap,S=M.envMapRotation;T&&(m.envMap.value=T,Ni.copy(S),Ni.x*=-1,Ni.y*=-1,Ni.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(Ni.y*=-1,Ni.z*=-1),m.envMapRotation.value.setFromMatrix4(k0.makeRotationFromEuler(Ni)),m.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,M,T){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*M,m.scale.value=T*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function d(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function u(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,M){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Ot&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=M.texture,m.transmissionSamplerSize.value.set(M.width,M.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function v(m,p){let M=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(M.matrixWorld),m.nearDistance.value=M.shadow.camera.near,m.farDistance.value=M.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function G0(s,e,t,n){let i={},r={},a=[],o=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function l(M,T){let S=T.program;n.uniformBlockBinding(M,S)}function c(M,T){let S=i[M.id];S===void 0&&(g(M),S=h(M),i[M.id]=S,M.addEventListener("dispose",m));let w=T.program;n.updateUBOMapping(M,w);let E=e.render.frame;r[M.id]!==E&&(u(M),r[M.id]=E)}function h(M){let T=d();M.__bindingPointIndex=T;let S=s.createBuffer(),w=M.__size,E=M.usage;return s.bindBuffer(s.UNIFORM_BUFFER,S),s.bufferData(s.UNIFORM_BUFFER,w,E),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,T,S),S}function d(){for(let M=0;M<o;M++)if(a.indexOf(M)===-1)return a.push(M),M;return we("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(M){let T=i[M.id],S=M.uniforms,w=M.__cache;s.bindBuffer(s.UNIFORM_BUFFER,T);for(let E=0,C=S.length;E<C;E++){let x=Array.isArray(S[E])?S[E]:[S[E]];for(let b=0,W=x.length;b<W;b++){let R=x[b];if(f(R,E,b,w)===!0){let F=R.__offset,B=Array.isArray(R.value)?R.value:[R.value],O=0;for(let G=0;G<B.length;G++){let z=B[G],D=v(z);typeof z=="number"||typeof z=="boolean"?(R.__data[0]=z,s.bufferSubData(s.UNIFORM_BUFFER,F+O,R.__data)):z.isMatrix3?(R.__data[0]=z.elements[0],R.__data[1]=z.elements[1],R.__data[2]=z.elements[2],R.__data[3]=0,R.__data[4]=z.elements[3],R.__data[5]=z.elements[4],R.__data[6]=z.elements[5],R.__data[7]=0,R.__data[8]=z.elements[6],R.__data[9]=z.elements[7],R.__data[10]=z.elements[8],R.__data[11]=0):(z.toArray(R.__data,O),O+=D.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,F,R.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function f(M,T,S,w){let E=M.value,C=T+"_"+S;if(w[C]===void 0)return typeof E=="number"||typeof E=="boolean"?w[C]=E:w[C]=E.clone(),!0;{let x=w[C];if(typeof E=="number"||typeof E=="boolean"){if(x!==E)return w[C]=E,!0}else if(x.equals(E)===!1)return x.copy(E),!0}return!1}function g(M){let T=M.uniforms,S=0,w=16;for(let C=0,x=T.length;C<x;C++){let b=Array.isArray(T[C])?T[C]:[T[C]];for(let W=0,R=b.length;W<R;W++){let F=b[W],B=Array.isArray(F.value)?F.value:[F.value];for(let O=0,G=B.length;O<G;O++){let z=B[O],D=v(z),K=S%w,$=K%D.boundary,ae=K+$;S+=$,ae!==0&&w-ae<D.storage&&(S+=w-ae),F.__data=new Float32Array(D.storage/Float32Array.BYTES_PER_ELEMENT),F.__offset=S,S+=D.storage}}}let E=S%w;return E>0&&(S+=w-E),M.__size=S,M.__cache={},this}function v(M){let T={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(T.boundary=4,T.storage=4):M.isVector2?(T.boundary=8,T.storage=8):M.isVector3||M.isColor?(T.boundary=16,T.storage=12):M.isVector4?(T.boundary=16,T.storage=16):M.isMatrix3?(T.boundary=48,T.storage=48):M.isMatrix4?(T.boundary=64,T.storage=64):M.isTexture?Se("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Se("WebGLRenderer: Unsupported uniform value type.",M),T}function m(M){let T=M.target;T.removeEventListener("dispose",m);let S=a.indexOf(T.__bindingPointIndex);a.splice(S,1),s.deleteBuffer(i[T.id]),delete i[T.id],delete r[T.id]}function p(){for(let M in i)s.deleteBuffer(i[M]);a=[],i={},r={}}return{bind:l,update:c,dispose:p}}function W0(){return Cn===null&&(Cn=new cs(H0,16,16,Pi,Rn),Cn.name="DFG_LUT",Cn.minFilter=mt,Cn.magFilter=mt,Cn.wrapS=Qt,Cn.wrapT=Qt,Cn.generateMipmaps=!1,Cn.needsUpdate=!0),Cn}var of,lf,cf,hf,uf,df,ff,pf,mf,gf,_f,xf,vf,yf,Mf,Sf,bf,Tf,Af,Ef,wf,Rf,Cf,If,Pf,Lf,Df,Nf,Uf,Ff,Of,Bf,zf,kf,Vf,Gf,Hf,Wf,Xf,qf,Yf,Zf,Kf,Jf,$f,jf,Qf,ep,tp,np,ip,sp,rp,ap,op,lp,cp,hp,up,dp,fp,pp,mp,gp,_p,xp,vp,yp,Mp,Sp,bp,Tp,Ap,Ep,wp,Rp,Cp,Ip,Pp,Lp,Dp,Np,Up,Fp,Op,Bp,zp,kp,Vp,Gp,Hp,Wp,Xp,qp,Yp,Zp,Kp,Jp,$p,jp,Qp,em,tm,nm,im,sm,rm,am,om,lm,cm,hm,um,dm,fm,pm,mm,gm,_m,xm,vm,ym,Mm,Sm,bm,Tm,Am,Em,wm,Rm,Cm,Im,Pm,Lm,Dm,Nm,Um,Fm,Om,Bm,zm,Oe,le,In,yo,Di,km,ci,du,Ui,qm,xr,fu,Gl,Hl,Wl,Xl,Ym,So,bo,sg,Uu,Zl,Fu,Ou,Bu,_u,xu,vu,yu,Mu,Kl,Jl,$l,ql,Ss,Yg,Zg,Tu,jg,Mo,s0,r0,o0,c0,u0,f0,m0,v0,Ql,ec,E0,I0,P0,L0,D0,Du,vr,Yl,B0,z0,tc,nc,Ni,k0,H0,Cn,To,wo=As(()=>{Vl();Vl();of=`#ifdef USE_ALPHAHASH
...
}`,L0=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],D0=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)],Du=new Ue,vr=new U,Yl=new U;B0=`
void main() {
