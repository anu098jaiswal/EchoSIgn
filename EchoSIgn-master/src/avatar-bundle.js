...
`)+`
`+p);let T=M+m+a,S=M+p+o,E=bu(i,i.VERTEX_SHADER,T),w=bu(i,i.FRAGMENT_SHADER,S);i.attachShader(v,E),i.attachShader(v,w),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function C(R){if(s.debug.checkShaderErrors){let N=i.getProgramInfoLog(v)||"",O=i.getShaderInfoLog(E)||"",V=i.getShaderInfoLog(w)||"",H=N.trim(),z=O.trim(),G=V.trim(),Q=!0,J=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(Q=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,v,E,w);else{let ce=Au(i,E,"vertex"),pe=Au(i,w,"fragment");we("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
...
}`,L0=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],D0=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)],Du=new Ue,Mr=new U,Yl=new U;B0=`
void main() {
